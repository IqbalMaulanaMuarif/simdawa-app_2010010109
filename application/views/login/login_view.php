...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/vendor/fonts/circular-std/style.css" rel="stylesheet') ?>">
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center">
                <h1>SIMDAWA-APP</h1>
                <span class="spalsh-description">Silahkan Login Terlebih dahulu</span>
            </div>
            <div class="card-body">
