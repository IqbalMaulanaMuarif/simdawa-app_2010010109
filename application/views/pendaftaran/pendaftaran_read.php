                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-secondary">
                            <div>Klik foto bukti daftar untuk melihat foto lebih jelas</div>
                        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    if ($a->keterangan == 'Belum Diverifikasi') :
                                        echo "<td>
                                            <a href=" . base_url('pendaftaran/verifikasi/acc' . $a->id) . " class='btn btn-sm btn-info'><i class='fa fa-check'></i> Konfirmasi</a>
                                            <a href=" . base_url('pendaftaran/verifikasi/batal' . $a->id) . " class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin batalkan akun ini?\")'><i class='fas fa-ban'></i> Batalkan</a>
                                        </td>";
                                    else :
